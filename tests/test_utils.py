...
class TestUtils(RQTestCase):
    ...
    def test_utcparse(self):
        ...
        self.assertEqual(
            datetime.datetime(2017, 8, 31, 10, 14, 2, 123456, tzinfo=datetime.timezone.utc), utcparse(utc_formated_time)
        )
    ...
    def test_utcparse_legacy(self):
        ...
        self.assertEqual(
            datetime.datetime(2017, 8, 31, 10, 14, 2, tzinfo=datetime.timezone.utc), utcparse(utc_formated_time)
        )
