...
* `rate_limited`: The job is waiting for capacity under a concurrency rate limit. It exists in Redis but is not placed on a queue or included in queue counts until capacity becomes available.
