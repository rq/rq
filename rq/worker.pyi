...
from typing import Any, Optional, Callable, Type, List, Iterable
...
class Worker:
    ...
    def perform_job(self, job: Job, queue: Queue, heartbeat_ttl: Optional[Any] = ...): ...
