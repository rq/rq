...
from .job import Job as Job, JobStatus as JobStatus, Retry, RunCondition
...
from typing import Any, Optional, Iterable, Union, Type, Callable, Tuple, List
...
class Queue:
    ...
    @classmethod
    def all(
        cls, connection: Optional[Redis] = ..., job_class: Optional[Type[Job]] = ..., serializer: Optional[Any] = ...
    ): ...
    @classmethod
    def from_queue_key(
        cls,
    ...
    def remove(self, job_or_id: Union[Job, str], pipeline: Optional[Pipeline] = ...): ...
    def compact(self) -> None: ...
    def push_job_id(self, job_id: str, pipeline: Optional[Pipeline] = ..., at_front: bool = ...) -> None: ...
    def create_job(
        self,
        func: Any,
        args: Optional[tuple] = ...,
        ...
        run_when: Optional[Union[str, Iterable[str]]] = ...,
    ) -> Job: ...
    def enqueue_call(
        self,
        func: Any,
    ...
    def defer_job(self, job: Job, pipeline: Optional[Pipeline] = ...) -> bool: ...
    ...
    def schedule_job(self, job: Job, datetime: datetime.datetime, pipeline: Optional[Pipeline] = ...) -> Job: ...
    def enqueue_in(self, time_delta: datetime.timedelta, func: Any, *args: Any, **kwargs: Any) -> Job: ...
    def enqueue_job(self, job: Job, pipeline: Optional[Pipeline] = ..., at_front: bool = ...) -> Job: ...
    ...
    @classmethod
    def dequeue_any(
        cls, queues: List[Union[str, Queue]], timeout: Any, connection: Optional[Redis] = ..., job_class: Optional[Any] = ...
    ): ...
