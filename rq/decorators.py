...
class job:  # noqa
    ...
    def __init__(
        ...
        Args:
            ...
            on_failure (Optional[Union['Callback', Callable[..., Any]]], optional): Callable to run on failure. Defaults to None.
            on_success (Optional[Union['Callback', Callable[..., Any]]], optional): Callable to run on success. Defaults to None.
            on_stopped (Optional[Union['Callback', Callable[..., Any]]], optional): Callable to run when stopped. Defaults to None.
        """
        self.queue = queue
