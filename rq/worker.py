...
class BaseWorker:
    ...
    def __init__(
        ...
        self.job_class = import_job_class(job_class) if isinstance(job_class, str) else (job_class if job_class else Job)
        self.queue_class = import_queue_class(queue_class) if isinstance(queue_class, str) else (queue_class if queue_class else Queue)
