...
class Worker:
    ...
    def __init__(self, queues, name: Optional[str] = None, default_result_ttl=DEFAULT_RESULT_TTL,
                 ...
                 default_worker_ttl=DEFAULT_WORKER_TTL, job_class: Optional[Type['Job']] = None,
    ...
    def count(cls, connection: Optional['Redis'] = None, queue: Optional['Queue'] = None) -> int:
        ...
        Args:
            ...
            queue (Optional[Queue], optional): The Queue instance. Defaults to None.

        Returns:
            count (int): The number of workers
        """
        return len(get_keys(queue=queue, connection=connection))

    @classmethod
    def find_by_key(cls, worker_key: str, connection: Optional['Redis'] = None, job_class: Optional[Type['Job']] = None,
                    queue_class: Optional[Type['Queue']] = None, serializer=None):
